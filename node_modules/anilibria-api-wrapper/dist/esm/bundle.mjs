...
const getAnilibriaUpdates = async (params = {}) => {
    try {
        return await getAnilibriaData('/getUpdates', params);
    }
    catch (error) {
        throw error;
    }
...
export { ANILIBRIA_API_URI_BY_DEFAULT, Anilibria, anilibriaAdvancedSearch, anilibriaSearchTitles, getAnilibriaCachingNodes, getAnilibriaChanges, getAnilibriaFeed, getAnilibriaGenres, getAnilibriaRandomTitle, getAnilibriaRss, getAnilibriaSchedule, getAnilibriaSeedStats, getAnilibriaTeam, getAnilibriaTitle, getAnilibriaTitles, getAnilibriaUpdates, getAnilibriaYears, getAnilibriaYouTube };
